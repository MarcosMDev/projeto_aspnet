...
namespace Covid19.Controllers
{
    public class TipsController : Controller
    {
        ...
        public TipsController(MvcTipsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,UrlImg,Title,Resume,Content,Autor,References,ReleaseDate")] Tips tips)
        {
